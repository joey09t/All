		...
		switch(choice) {
			...
			case "7":	System.out.println("Enter your Mobile number ");
						...
						if(flag==1) {
							...
							System.out.println("Final Balance after transfer of account 1 is:"+ob1.getBalance() );
							System.out.println("Final Balance after transfer of account 2 is:"+ob2.getBalance() );
